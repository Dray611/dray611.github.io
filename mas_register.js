...
{
  calcCart();
  document.getElementById("regComplete").onclick = sessionTest;
...
function calcCart ()
{
  ...
  sessionStorage.confBanquetCost = document.forms.regForm.elements.banquetGuests.value*50;
  ...
  if (document.forms.regForm.elements.mediaCB.checked)
  {
    ...
    sessionStorage.confPackCost = 120;
  }
  else
  {
